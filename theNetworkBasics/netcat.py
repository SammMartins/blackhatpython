    ...
    def handle(self, client_socket):
        if self.args.execute:
            ...
            with open(self.args.upload, 'wb') as f:
                f.write(file_buffer)
            message = f'Arquivo {self.args.upload} salvo'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        netcat.py -t 192.168.1.108 -p 5555 -l -u=mytest.txt # fazer upload de um arquivo
        netcat.py -t 192.168.1.108 -p 5555 -l -e=\"cat /etc/passwd\" # executar comando
        echo 'ABC' | ./netcat.py -t 192.168.1.108 -p 135 # ecoar texto para a porta 135 do servidor
    ...
    parser.add_argument('-u', '--upload', help='upload de arquivo')
